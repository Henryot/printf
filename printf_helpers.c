...
/**
 * print_hexadecimal - Print an unsigned integer as a lowercase hexadecimal number.
 * @args: The list of arguments containing the integer to print.
 *
 * Return: The number of characters printed.
 */
...
/**
 * print_hexadecimal_upper - Print an unsigned integer as an uppercase hexadecimal number.
 * @args: The list of arguments containing the integer to print.
 *
 * Return: The number of characters printed.
 */
